...
$responce = array(
	...
	'news' => '<h4>Есть обновления!</h4> 
				...
				<ul>		
					<li>Исправлена ошибка подстановки Дежурных шаблонов в карточке товара;</li>	
					<li>В карточке товара добавлена кнопка (по многочисленным просьбам), которая
   						включает режим клонирования выбранного из выпадающего списка Значения или
   						Шаблона во все языки;</li>					
				</ul>',
